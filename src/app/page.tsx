        ...
        <main className="min-h-screen flex flex-col items-center justify-center p-8 text-center bg-black">
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-white text-3xl mb-20 leading-relaxed">
                    To use this bot, please add it to your Discord server clicking button below and contact the Dev to get agent permission for pair trades in your channel.
                </p>
